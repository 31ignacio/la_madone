...
{{-- ════ KPI CARDS ════ --}}
    <div class="row">
        <div class="col-6 col-lg-3">
            <a href="{{ route('rapports.ventes') }}" class="kpi-card kpi-green">
        ...
        <div class="col-6 col-lg-3">
            <a href="{{ route('factures.index') }}" class="kpi-card kpi-orange">
                <div class="kpi-ico"><i class="fas fa-shopping-cart"></i></div>
                <div class="kpi-val">{{ $ventesJour }}</div>
                <div class="kpi-lbl">Ventes aujourd'hui</div>
                <div class="kpi-foot">
        ...
        <div class="col-6 col-lg-3">
            <a href="{{ route('alertes.index') }}" class="kpi-card kpi-red">
                <div class="kpi-ico"><i class="fas fa-bell"></i></div>
                <div class="kpi-val">{{ $alertesNonTraitees }}</div>
                <div class="kpi-lbl">Alertes stock</div>
                <div class="kpi-foot">
                    <i class="fas fa-arrow-right"></i> Voir les alertes
                </div>
            </a>
        </div>
    </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="pd-card">
                ...
                @forelse($topProduits as $i => $produit)
                    <div class="top-item">
                        <div class="top-rank {{ $i == 0 ? 'rank-1' : ($i == 1 ? 'rank-2' : ($i == 2 ? 'rank-3' : 'rank-n')) }}">
                            {{ $i + 1 }}
                        </div>
